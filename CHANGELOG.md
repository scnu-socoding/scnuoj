...
- 2021.1.14 Chg: [web] 后台支持使用学号查找用户。
- 2021.1.13 Chg: [web] 添加题目标签显示开关。
- 2021.1.12 Chg: [web] 为小组和比赛添加搜索。
- 2021.1.9 Chg: [judge] AC 的测试点同样显示测试点信息。
...
- 2020.11.23 Chg: [web] 管理员参加比赛默认打星，不计入排名。
