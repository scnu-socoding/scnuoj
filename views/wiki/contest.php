...
<div class="table-responsive">
    ...
    <br />
    <h3>关于积分</h3>
    <p>　　在参加 AK 杯、蓝桥杯热身赛、天梯赛选拔赛等比赛之后，参赛者将根据排名得到一定积分。积分榜单可在 <?= \yii\helpers\Html::a('排行榜页面', ['/rating'], ['target' => '_blank']) ?> 查看。如果参加了比赛但没有通过任何题目，不会计算比赛积分。积分可以一定程度反映参赛者的程序设计能力，在需要时可作为学院 ACM 集训队选拔参考依据之一。
    </p>
