...
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="card text-dark">
            <div class="card-body">
                <h3 class="card-title">关于积分</h3>
                <p>在参加比赛之后，参赛者将根据排名得到一定积分。如果参加了比赛但没有通过任何题目，不会计算比赛积分。</p>
                <p>积分计算采用 Elo Ranking 算法，起始分为 1149。该算法已被牛客竞赛等多个知名判题系统采用。想要了解该算法的更多信息，请查看 <a
                        href="https://en.wikipedia.org/wiki/Elo_rating_system" target="_blank" class="text-dark">
                        Wikipedia 相关词条</a>。</p>
