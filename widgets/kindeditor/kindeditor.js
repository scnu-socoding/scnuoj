...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		'.ke-content pre {white-space:pre-wrap;display: block; padding: 9.5px;margin: 0 0 10px;font-size: 15px;font-family: Menlo, Monaco, Consolas, Courier New, monospace;line-height: 1.42857143;color: #333;word-break: break-all;word-wrap: break-word; background-color: #f5f5f5;border: 1px solid #ccc;}',
		...
		var lang = self.lang(name + '.'),
			...
			dialog = self.createDialog({
				...
				yesBtn : {
					...
					click : function(e) {
							code = textarea.val(),
							html = '<pre><p>' + K.escape(code) + '</p></pre> ';
						if (K.trim(code) === '') {
