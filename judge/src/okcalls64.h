...
int LANG_CV[CALL_ARRAY_SIZE] = {
	SYS_read, SYS_write, SYS_mprotect, SYS_arch_prctl, SYS_munmap, SYS_brk, SYS_pread64, SYS_open,
	SYS_dup3, SYS_exit, SYS_rt_sigaction, SYS_execve, SYS_writev,
	SYS_time, SYS_futex, SYS_set_thread_area, SYS_access, SYS_clock_gettime, SYS_exit_group, SYS_mq_open,
	SYS_ioprio_get, SYS_unshare, SYS_set_robust_list, SYS_splice, SYS_close, SYS_stat, SYS_fstat, 
